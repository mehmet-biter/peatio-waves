RSpec.describe Peatio::Waves::Wallet do
  let(:wallet) { Peatio::Waves::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Waves::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Waves::Wallet::SUPPORTED_SETTINGS))
    end
  end
